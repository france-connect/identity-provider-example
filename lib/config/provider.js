...
var _oidcAccount = require('../services/oidc-account');
...
const provider = exports.provider = {
  ...
  claims: {
    ...
    profile: ['sub', 'given_name', 'family_name', 'birthdate', 'gender', 'birthplace', 'birthcountry', 'preferred_username']
  },
  ...
  findById: _oidcAccount.findById
};